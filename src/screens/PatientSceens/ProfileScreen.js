    ...
    <ScrollView style={styles.container}>
      <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
        ...
        <Card containerStyle={styles.cardContainer}>
          ...
          <Text style={styles.email}>+33 61112154855</Text>
          <Text style={styles.email}>11 rue jean mertz, Lille</Text>
        </Card>
        <TouchableOpacity
          style={styles.button1Style}
          activeOpacity={0.5}
          onPress={() => navigation.navigate('PersonalDataScreen')}>
          <Text style={styles.button1TextStyle}>Données personelles</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.button2Style}
          activeOpacity={0.5}
          onPress={() => navigation.navigate('HealthDataScreen')}>
          <Text style={styles.button2TextStyle}>Données médicales</Text>
        </TouchableOpacity>
      </View>
    </ScrollView>
  );
